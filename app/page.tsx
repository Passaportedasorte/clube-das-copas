  ...
  return (
    <main className="min-h-screen bg-[#063A2A] text-white overflow-hidden">
      <section className="relative min-h-screen">
        ...
        <div className="absolute top-10 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-[#D4AF37]/25 blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-5 md:px-6 py-14 md:py-24">
          <div className="text-center max-w-5xl mx-auto">
            <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full border border-[#D4AF37]/40 bg-[#063A2A]/80 shadow-[0_0_60px_rgba(212,175,55,0.25)]">
            ...
            <h1 className="mt-7 text-5xl md:text-8xl font-black leading-[0.95] tracking-tight">
              GANHE
              <span className="block text-[#D4AF37]">R$ 5.000</span>
              ACERTANDO PALPITES
            </h1>

            <p className="max-w-3xl mx-auto mt-7 text-lg md:text-2xl text-white/80 leading-relaxed">
              Faça seus palpites durante toda a Copa do Mundo 2026, acumule
              pontos e dispute
...
<div className="mt-4 inline-flex items-center gap-2 bg-white/10 border border-white/10 px-4 py-2 rounded-full text-sm font-bold">
  🔥 Centenas de palpites já foram cadastrados na plataforma
            ...
            <div className="mt-8 rounded-3xl bg-[#031D15]/70 border border-[#D4AF37]/25 p-4 shadow-[0_0_40px_rgba(0,0,0,0.25)]">
  ...
  🏆 R$ 10.000 em premiações • Entrada única de R$ 49,90
          ...
          <div className="grid md:grid-cols-4 gap-5 mt-16 md:mt-24">
            <div className="bg-[#063A2A]/90 border border-[#D4AF37]/30 rounded-3xl p-6 shadow-[inset_0_0_40px_rgba(212,175,55,0.06)]">
              <p className="text-sm text-white/60 font-bold">Premiação total</p>
              <p className="text-4xl font-black mt-2 text-[#D4AF37]">
                R$ 10.000
              </p>
              <p className="text-white/60 text-sm mt-2">
                Distribuídos entre os melhores colocados.
              </p>
            </div>

            <div className="bg-[#063A2A]/90 border border-[#D4AF37]/20 rounded-3xl p-6">
              <p className="text-sm text-white/60 font-bold">Maior prêmio</p>
              <p className="text-4xl font-black mt-2 text-white">R$ 5.000</p>
              <p className="text-white/60 text-sm mt-2">
                Para quem terminar no topo do ranking geral.
              </p>
            </div>

            <div className="bg-[#063A2A]/90 border border-[#D4AF37]/20 rounded-3xl p-6">
              <p className="text-sm text-white/60 font-bold">Entrada</p>
              <p className="text-4xl font-black text-[#D4AF37] mt-2">
                R$ 49,90
              </p>
              <p className="text-white/60 text-sm mt-2">
                Acesso durante toda a Copa do Mundo.
              </p>
            </div>

            <div className="bg-[#063A2A]/90 border border-[#D4AF37]/20 rounded-3xl p-6">
              <p className="text-sm text-white/60 font-bold">Ranking</p>
              <p className="text-4xl font-black text-white mt-2">Ao vivo</p>
              <p className="text-white/60 text-sm mt-2">
                Pontuação automática após os resultados.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-[#063A2A] border border-[#D4AF37]/25 rounded-[2rem] p-8 md:p-16 text-white shadow-[0_0_60px_rgba(0,0,0,0.25)]">
            ...
            <h2 className="mt-4 text-4xl md:text-6xl font-black text-center">
              Seu palpite pode valer R$ 5.000.
            </h2>
            ...
            <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-10 items-center">
              <div>
                ...
                <p className="text-white/65 mt-5 text-lg leading-relaxed">
                  Além de participar do Ranking Geral do Clube das Copas, você
                  também pode criar uma liga privada para competir com amigos,
                  família, colegas de trabalho ou aquele grupo que vive falando
                  que entende de futebol.
                </p>

                <div className="grid md:grid-cols-2 gap-4 mt-8">
                  <div className="bg-[#031D15]/70 border border-[#D4AF37]/20 rounded-3xl p-5">
                    <p className="text-3xl">🏆</p>
                    <p className="font-black mt-3">Ranking exclusivo</p>
                  ...
                  <div className="bg-[#031D15]/70 border border-[#D4AF37]/20 rounded-3xl p-5">
                    <p className="text-3xl">👥</p>
                    <p className="font-black mt-3">Convite por código</p>
                    <p className="text-white/55 text-sm mt-2">
                ...
                <div className="mt-5 space-y-4">
                  {[
                    ...
                    >
                      ...
                      <span className="font-black text-white/70">{item[2]}</span>
                    </div>
                  ))}
                </div>
          ...
          <div className="mt-20 md:mt-24 text-center bg-[#063A2A] border border-[#D4AF37]/30 rounded-[2rem] p-8 md:p-14 shadow-[inset_0_0_50px_rgba(212,175,55,0.07)]">
            ...
            <p className="text-white/65 mt-4 max-w-2xl mx-auto">
              Entre na competição, acompanhe sua posição no ranking e dispute
              R$10.000 em premiações.
            </p>
